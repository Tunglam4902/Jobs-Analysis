...
def main():
    ...
    print("Starting application: Careerbuilder")

    # Đọc từ Kafka
    kafka_df = spark.readStream \
        .format("kafka") \
        .option("kafka.bootstrap.servers", "kafka-1:9092") \
        .option("subscribe", "careerbuilder") \
        .load()

    print("Connected to Kafka topic: careerbuilder")

    # Hiển thị dữ liệu từ Kafka
    ...
    # Kết nối MongoDB (thêm log để kiểm tra)
    try:
        mongo_uri = "mongodb://mymongodb:27017/"
        db_name = "job-analysis"
        ...
        print("MongoDB connection established and streaming to database.")
